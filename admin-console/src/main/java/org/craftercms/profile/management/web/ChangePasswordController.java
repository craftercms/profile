...
public class ChangePasswordController {
	 ...
	 * @param forgotPassword <code>ForgotPassword</code> instance that contains the admin-console tenant name and the username entered
	 * 
	 ...
	 * 
	 * @throws AppAuthenticationFailedException If an appToken exception occurred
	 */
	...
	/**
	 * Post to manage the change password process.Validates that both new password and confirm password are the same and are not blanket
	 * 
	 ...
	 * @param bindingResult Binding result for <code>ForgotPassword</code> instance
	 */
	private void validateForgetPassword(ForgotPassword forgotPassword,
