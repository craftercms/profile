...
<div id="content">
    <div id="header">
        ...
        <h1 class="mainTitle">Updating Mapping for Tenant: ${tenant.tenantName}</h1>
    </div>
    <form id="form-item" onsubmit="return onsubmitform();">
        <div class="box pad mt40 style-inputs">
            <p>
                <label id="groupName" for="groupName">Group Name:</label>
                <span class="unit size1of3">${group.name!""}</span><br/>
            </p>
        <@crafter.formInput "group.name","name", "style=width:270", "hidden"/>
            <p>
        ...
        <@crafter.formInput "group.id", "id", "style=width:270", "hidden"/>
            <p>
                <label>&nbsp;</label>
                <button class="btn btn-info" id="UpdateGroup" type="submit" value="Accept"
                        onclick="document.pressed=this.id">Accept
                </button>
                <button class="btn btn-info" name="operation" id="cancel-account-btn" type="submit" value="CancelGroup"
