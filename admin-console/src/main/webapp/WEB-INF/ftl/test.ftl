...
<div id="content">
    ...
    <fieldset>
        ...
        <td>
            ...
            <div>
                 <span>
                      <input name="operation" class="new-account-btn" id="new-account-btn" type="submit" value="Create"
                             onclick="document.pressed=this.value"/>
                 </span>
                 <span>
                      <input name="operation" class="cancel-account-btn" id="cancel-account-btn" type="submit"
                             value="Cancel" onclick="document.pressed=this.value"/>
                 </span>
            </div>
        </form>
    </fieldset>
