        ...
        <div class="top">
            <div class="pad">
                ...
                <nav>
                    ...
                    <#if (enableDelete) >
                        <li><a type="submit" href="javascript:onsubmitform('DeleteRole');"
                               onclick="javascript:onsubmitform('DeleteRole');" value="Delete Role" id="DeleteRole"
                               name="operation">Delete Role</a></li>
                    </#if>
