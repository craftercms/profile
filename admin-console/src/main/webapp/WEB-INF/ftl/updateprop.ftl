...
<html lang="en">
<head>
    <title>Crafter Admin Console - Update Attribute</title>
...
<div id="content">
    ...
    <form id="form-item" onsubmit="return onsubmitform();">
        ...
        <p>
            <label>&nbsp;</label>
            <button class="btn btn-info" id="UpdateProp" type="submit" value="Accept"
                    onclick="document.pressed=this.id">Accept
            </button>
            <button class="btn btn-info" name="operation" id="cancel-account-btn" type="submit" value="CancelProp"
