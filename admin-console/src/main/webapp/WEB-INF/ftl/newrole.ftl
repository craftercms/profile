...
<div id="content">
    ...
    <form id="form-item" onsubmit="return onsubmitform();">
        <div class="box pad mt40 style-inputs">
            ...
            <p>
                <label>&nbsp;</label>
                <button class="btn btn-info" id="CreateRole" type="submit" value="Accept"
                        onclick="document.pressed=this.id">Accept
                </button>
                <button class="btn btn-info" name="operation" id="cancel-account-btn" type="submit" value="CancelRole"
