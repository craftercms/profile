...
<div id="content">
	...
	<div id="header">
	 	<a class="logo" href="#" title="Crafter CMS"></a> 
    ...
    <div class="top">
		...
		<nav>
			<ul class="main-nav clearfix">
				<li><a type="submit" href="javascript:onsubmitform('NewRole');" onclick="javascript:onsubmitform('NewRole');" value="New Role" id="NewRole" name="operation">New Role</a></li>
  ...
  <table id="mytable">
    ...
    <#list roleList as role>
      <tr>
        <td><a name="name" href="role_detail?roleName=${role.roleName}" id="${role.roleName}">${role.roleName!""}</a></td>
