            ...
            <div class="pad">
                <nav>
                    <ul class="main-nav clearfix">
                        <li><a type="submit" href="javascript:onsubmitform('NewProp');" value="New Profile" id="New"
                               name="operation">New Attribute</a></li>
                        <li><a type="submit" href="javascript:onsubmitform('DeleteProp');" value="Delete Profile"
                               id="Delete" name="operation">Delete Attribute</a></li>
                        <li><a type="submit" href="" value="Search" id="backTenant" name="operation">Back to Tenant</a>
                        </li>
                    </ul>
                </nav>
            </div>
