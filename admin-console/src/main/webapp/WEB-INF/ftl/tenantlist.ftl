		...
		<nav>
	    	...
	    	<ul class="page-actions">
                <li><@crafter.formInput "filter.tenantName", "filter", "style=width:120px", "text"/>
                     <a type="submit" href="javascript:onsubmitform('FilterTenant');" value="Search" id="Search" name="operation">Search</a></li>
                <li><a type="submit" href="javascript:onsubmitform('PreviousTenant');" value="Previous Tenant" id="PreviousTenant" name="operation">&lt;&lt;</a></li>
                <li><a type="submit" href="javascript:onsubmitform('NextTenant');" value="Next Tenant" id="NextTenant" name="operation">&gt;&gt;</a></li>
		   </ul>
	    </nav>
	    </div>
   </div>
