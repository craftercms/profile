    ...
    <form id="form-item" onsubmit="return onsubmitform();">
        ...
        <@crafter.formInput "tenant.tenantName", "tenantName", "style=width:270", "hidden"/>
            ...
            <@crafter.showErrors "error-msg", "mbs", ""/>
                ...
                <button class="btn btn-info" id="Groups" type="submit" value="Groups"
                        onclick="document.pressed=this.id">Manage Groups-Roles Mapping
                </button>
        ...
        <@crafter.showErrors "error-msg", "mbs", ""/>
            ...
            <p>
                <label>&nbsp;</label>
                <button class="btn btn-info" id="UpdateTenant" type="submit" value="UpdateTenant"
                        onclick="document.pressed=this.id">Accept
                </button>
                <button class="btn btn-info" name="operation" id="cancel-account-btn" type="submit" value="GetTenants"
