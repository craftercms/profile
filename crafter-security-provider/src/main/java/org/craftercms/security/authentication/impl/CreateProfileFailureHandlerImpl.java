...
public class CreateProfileFailureHandlerImpl extends BaseHandler implements CreateProfileFailureHandler {
     ...
     */
    @Override
    public void onCreateProfileFailure(Exception e, RequestContext context) throws CrafterSecurityException,
        IOException {
    ...
    protected void saveException(Exception e, RequestContext context) {
        ...
        if (e instanceof Exception) {
            session.setAttribute(SecurityConstants.PROFILE_CREATE_EXCEPTION,
                new CrafterSecurityException(e.getMessage()));
        }
    }
