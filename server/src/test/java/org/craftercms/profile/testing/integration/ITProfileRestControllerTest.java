...
public class ITProfileRestControllerTest extends BaseTest {
	...
	public void testGetProfileByIdWithAttributes() throws AppAuthenticationFailedException {
		...
		Profile expectedProfile = profileRestClientImpl.getProfileWithAttributes(appToken, profile.getId().toString(), attributes);
	...
	public void testGetProfileByIdWithAllAttributes() throws AppAuthenticationFailedException {
		...
		Profile expectedProfile = profileRestClientImpl.getProfileWithAllAttributes(appToken, profile.getId().toString());
		assertNotNull(expectedProfile);
		assertEquals(profile.getUserName(),expectedProfile.getUserName());
	}
	...
	@Test
	public void testGetProfileByTicketWithAttributes() throws AppAuthenticationFailedException, UserAuthenticationFailedException {
		initAppToken();
		String ticket = profileRestClientImpl.getTicket(appToken, "admin", "admin", tenantName);
		assertNotNull(ticket);
		List<String> attributes = new ArrayList<String>();
	...
	@Test
	public void testGetProfileByTicketWithAllAttributes() throws AppAuthenticationFailedException, UserAuthenticationFailedException {
		initAppToken();
		String ticket = profileRestClientImpl.getTicket(appToken, "admin", "admin", tenantName);
		assertNotNull(ticket);
	...
	public void testGetProfileByUsernameWithAttributes() throws AppAuthenticationFailedException {
		...
		List<String> attributes = new ArrayList<String>();
		attributes.add("first-name");
		Profile profile = profileRestClientImpl.getProfileByUsernameWithAttributes(appToken, "admin", tenantName, attributes);
		assertNotNull(profile);
		assertEquals("Wrong Username", "admin", profile.getUserName());
	}
	@Test
	...
	public void testUpdateProfile() throws AppAuthenticationFailedException {
		...
		Profile updatedProfile = profileRestClientImpl.getProfileWithAllAttributes(appToken, updateProfile.getId().toString());
		assertNotNull(updatedProfile);
		assertEquals("Update profile failed to update the first-name attribute", "adminupdateuser", updatedProfile.getAttributes().get("first-name"));
	...
	public void testDeleteAttributesProfile() throws AppAuthenticationFailedException {
		...
		Profile notAttributeProfile = profileRestClientImpl.getProfileWithAllAttributes(appToken, admindeleteattruser.getId());
		assertNotNull(notAttributeProfile);
...
//	}
	...
	public void testGetProfileRange() throws AppAuthenticationFailedException {
		...
		List<Profile> profiles = profileRestClientImpl.getProfileRange(appToken, "craftercms",
				0, 9, "modified", "ASC",attributes);
