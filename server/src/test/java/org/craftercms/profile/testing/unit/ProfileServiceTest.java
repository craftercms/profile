...
public class ProfileServiceTest {
	...
	public void startup() {
		...
		when(profileRepository.getProfileByUserName(ticket.getUsername(), ticket.getTenantName(), null)).thenReturn(current);
		when(profileRepository.getProfileByUserName(ticket.getUsername(), ticket.getTenantName(), attributesNames)).thenReturn(current);
