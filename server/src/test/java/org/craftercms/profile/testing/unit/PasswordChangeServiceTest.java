...
public class PasswordChangeServiceTest {
	...
	public void testForgotPassword() throws CipherException, MailException, NoSuchProfileException {
		...
		Mockito.verify(mailService).sendMailTLS(Mockito.<String>any(), Mockito.<String>any(), Mockito.<String>any(), Mockito.<Map<String, Object>>any(), Mockito.<String>any(), Mockito.<String>any());
	}
	
	@Test(expected=ExpiryDateException.class)
	public void testChangePassword_expirydate() throws CipherException, NoSuchProfileException, ParseException, ExpiryDateException  {
