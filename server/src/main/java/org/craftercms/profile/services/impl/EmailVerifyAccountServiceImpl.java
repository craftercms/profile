...
public class EmailVerifyAccountServiceImpl implements VerifyAccountService {
    ...
    /* (non-Javadoc)
     * @see org.craftercms.profile.services.VerifyAccountService#sendVerifyNotification(org.craftercms.profile.domain
     * .Profile, java.lang.String, javax.servlet.http.HttpServletRequest)
     */
    @Override
    public void sendVerifyNotification(Profile profile, String verifyAccountUrl, HttpServletRequest request) throws
        ...
        String encryptedToken = cipherPasswordChangeToken.encrypt(TokenHelper.getInstance().getRawValue(profile
            .getTenantName(), profile.getUserName()));
     ...
     */
    @Override
    public Profile verifyAccount(String token) throws CipherException, NoSuchProfileException, ParseException,
        ExpiryDateException, ProfileException {
     ...
     *
     * @param verifyEmailSubject Subject of the reset email
     */
