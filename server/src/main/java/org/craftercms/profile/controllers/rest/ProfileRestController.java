...
public class ProfileRestController {
	...
	@ModelAttribute
	public Profile createProfile(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
	...
	@ModelAttribute
	public long getProfilesCount(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@RequestParam(ProfileConstants.TENANT_NAME) String tenantName,
			HttpServletResponse response) {
	...
	@ModelAttribute
	public List<Profile> getProfileRange(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@RequestParam(ProfileConstants.TENANT_NAME) String tenantName,
			...
			@RequestParam(required = false, value = ProfileConstants.ATTRIBUTES) List<String> attributes, HttpServletResponse response) {
	...
	@ModelAttribute
	public Profile getProfile(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String profileId,
			HttpServletResponse response) {
	...
	@ModelAttribute
	public Profile getProfileWithAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String profileId,
			@RequestParam(ProfileConstants.ATTRIBUTES) List<String> attributes, HttpServletResponse response) {
	...
	@ModelAttribute
	public Profile getProfileWithAllAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String profileId,
			HttpServletResponse response) {
	...
	public Profile getProfileByUsernameWithAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, 
			@PathVariable String username,
			@RequestParam(ProfileConstants.TENANT_NAME) String tenantName,
			@RequestParam(required = false, value = ProfileConstants.ATTRIBUTES) List<String> attributes) throws NoSuchProfileException {
	...
	@ModelAttribute
	public Profile getProfileByUsernameWithAllAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String username,
			@RequestParam(ProfileConstants.TENANT_NAME) String tenantName) 
									throws NoSuchProfileException {
	...
	@ModelAttribute
	public Profile getProfileByTicket(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String ticket) 
											throws NoSuchProfileException {
	...
	@ModelAttribute
	public Profile getProfileByTicketWithAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String ticket,
			@RequestParam(required = false, value = ProfileConstants.ATTRIBUTES) List<String> attributes) throws NoSuchProfileException {
	...
	@ModelAttribute
	public Profile getProfileByTicketWithAllAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String ticket) 
									throws NoSuchProfileException {
	...
	public List<Profile> getProfiles(@RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@RequestParam(ProfileConstants.PROFILE_ID_LIST) List<String> profileIdList, HttpServletResponse response) {
	...
	@ModelAttribute
	public Profile updateProfile(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@RequestParam(ProfileConstants.PROFILE_ID) String profileId,
			@RequestParam(required = false, value = ProfileConstants.USER_NAME) String userName,
	...
	public Map<String, Serializable> getAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@PathVariable String profileId, @RequestParam(required = false, value = ProfileConstants.ATTRIBUTES) List<String> attributes,
			HttpServletResponse response) {
	...
	public Map<String, Serializable> getAttribute(@RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@PathVariable String profileId, @RequestParam("attributeKey") String attributeKey, HttpServletResponse response) {
	...
	@ModelAttribute
	public void deleteAttributes(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@PathVariable String profileId, @RequestParam(required = false, value = ProfileConstants.ATTRIBUTES) List<String> attributes,
			HttpServletResponse response) {
	...
	@ModelAttribute
	public void deleteAttributes(@RequestParam(ProfileConstants.APP_TOKEN) String appToken, @PathVariable String profileId,
			HttpServletResponse response) {
	...
	@ModelAttribute
	public List<Profile> getProfilesByRole(HttpServletRequest request, @RequestParam(ProfileConstants.APP_TOKEN) String appToken,
			@RequestParam(ProfileConstants.TENANT_ID) String tenantName,
