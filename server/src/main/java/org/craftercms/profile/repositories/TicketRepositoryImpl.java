...
public class TicketRepositoryImpl extends JongoRepository<Ticket> implements TicketRepository {
    ...
    @Override
    public void removeTicketsOlderThan(final long expirationSeconds) {
    ...
    @Override
    public Ticket findByTicket(final String ticketStr) throws MongoDataException {
        String series = TicketUtils.getTicketSeries(ticketStr);
        return findBySeries(series);
    }

    @Override
    public Ticket findByUsername(final String username) throws MongoDataException {
        ...
        try {
            ...
            throw new MongoDataException("Unable to find ");
        }
    }

    @Override
    public Ticket findBySeries(final String series) throws MongoDataException {
        ...
        if (series != null) {
            try {
                ...
                throw new MongoDataException("Unable to find ticket", e);
            }
        } else {
